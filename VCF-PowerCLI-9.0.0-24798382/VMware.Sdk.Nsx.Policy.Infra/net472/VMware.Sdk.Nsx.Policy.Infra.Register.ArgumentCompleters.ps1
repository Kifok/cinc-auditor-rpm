...
$getOperationNameScriptBlock = {
   ...
   [VMware.Sdk.Nsx.Policy.Infra.OperationRegistry]::GetRegistry().GetOperationNameCandidates($WordToComplete) | Foreach-Object {  [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_) }
}
...
$getOperationPathScriptBlock = {
   ...
   [VMware.Sdk.Nsx.Policy.Infra.OperationRegistry]::GetRegistry().GetOperationPathCandidates($WordToComplete) | Foreach-Object {  [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_) }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB1W4Z6PrXpxdNe
# HwD4wG0k6LfXT7KAQ66VMPvbfq8izaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEC8kQMOWTSIU3wM
# gBwdVU2tOKX5Wu0asOMVXjUlz9bOMA0GCSqGSIb3DQEBAQUABIICAA3KV00kUvJk
# czwkbTg/biU9hOLqQmBV152xvneRI9bk78hSIZUbJVIowtCuWSlOSg4kgGMYHxwz
# T/arHec2ZHoNyJ6CYKVst8s8WT655dgu/BBP6HVdYeYPh609bn6fGRdIUr1lNIEI
# 25ZGo2FOOSil1nvbMicOUuiwyx5fXfsYaE9xxoA3lMIATmmxjVU00BL8cbdKIn4u
# aOW1Pkv7m6osjPtC9i9ngYlZgkyuFD/ZPsAFsWgpOLXcTu6O1XKwjMidGBJBR/KZ
# x4t9ylO7xpBQwUr6LuU8r1Kiu3pKAoOC6qkZi4V8JuoinZW43YOVqcf5ccxBQg0N
# FjidG8XZw8/ue/y9d29EQw+WfGK8l+lBZOG4KrFGDMuLB+0wAuwbv2bC1GXEh9If
# QPKcaxE5IHfq+odq7VYLtd3V+5toa+yGo5BLZUJfaw1ytaSNvum5giTqsCsirP9K
# VLSJI0CH1UvglPhA17OMd6Z/Yb+U1PO9m8AKzyU6HtAe+SBDGmZuaIb2bOID8QBR
# pjtMUEk+6GN7+9XzOjTlPXqjijPxPyMHilMEHQCmdGLGCi5qN8gMf7SSXHu6T+q+
# b7eDaAdVokWcVxSAtlDW1imI1scVsV/O8PqxQhajYQ/83Lg9iferAATPvHOnRtov
# tuAYEGZYVt71x/UPzxdmo92pj1FwGk1roYIXdzCCF3MGCisGAQQBgjcDAwExghdj
...
# IAUsRMhqXBpfUbTxkfyKgXX/FLTAlpuj+IR6bwuNU4QKAhEA/4wIqhLDfYogTCQL
# Uv+odhgPMjAyNTA2MTcwODE0NThaoIITOjCCBu0wggTVoAMCAQICEAqA7xhLjfEF
...
# hkiG9w0BCQUxDxcNMjUwNjE3MDgxNDU4WjArBgsqhkiG9w0BCRACDDEcMBowGDAW
# BBTdYjCshgotMGvaOLFoeVIwB/tBfjAvBgkqhkiG9w0BCQQxIgQgM5KlUrvXWJY+
# TmsM41eK/qJwNv0h1pW8wSNKSdZo0DwwNwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQg
# SqA/oizXXITFXJOPgo5na5yuyrM/420mmqM08UYRCjMwDQYJKoZIhvcNAQEBBQAE
# ggIAV4sxg/IcrmCsh1cKRdNgIPKE5AiAr+NY2CMW/dNRxB1EGF0QzBxEGxd2Xfyg
# rvUBwCX4Lj2jUGbJuBXulMA2WE/QFIGv72yZCs0XE63PYpEU++9wGAT5zsQdGekX
# E5jCS6GgeFcusIgGiUvuNkdNJArRQd9NqyJPZajGnAF3cd8n/oIRjnbG6YIu3DKk
# c/OO3pWLyoKUDArkkVAk9LqQP5lfms6hHbmaVgFTKCZRe3R0wQ/0l+aogxcO4COe
# RRP3po69JCgaokgTgNv4mCLsAiHK5ptuv8wmL0Gyh+dqWu5KWDu7rgQuJNI9PZkA
# ge2qCTdPzwZCaiuusvbnX6Y1t8s/Lrtx/igCZceE8ccykjKZ00LmQmkX8AB9CRkn
# 4OBihaV4ezhi57hRgsS5HgSQjMiQMSEl98fP+SCfIJ+bmewg+mAn1IdX+7qRgkDE
# egCTrSegv/k3TvdOzAhCV/EazhAz9fceibaB0uAeWz+I0l3UWOGCp26iVfCWB4Ll
# PaM7Dw+gJI9QIVlhWy4wkWv4cvkXpT9nBjRJQnHuNpsWmU+jFRTyscyIs5umwiTM
# vJDyc+qwE55iWlCS/GYF5becGueMs/jyZTnDtl0yuT9P9d0lLA+G4R60GVguy3Pv
# 5KklNWQjodrmj49fOBfKXPPmdchL7vFnoPBs2HMOZpLltl4=

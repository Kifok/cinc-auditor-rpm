#
# Module manifest for module 'VMware.Sdk.Nsx.Policy.Infra'. Core version.
#
# Generated by: "VMware"
#
#
...
ModuleToProcess = 'VMware.Sdk.Nsx.Policy.Infra.Cmdlets.dll'
...
Description = 'This PowerShell module contains cmdlets for managing VMware.Sdk.Nsx.Policy.Infra API.'
...
RequiredAssemblies = @(
'VMware.Sdk.Nsx.Policy.Infra.Cmdlets.dll'
)
...
# FormatsToProcess = @("VMware.Sdk.Nsx.Policy.Infra.Format.ps1xml")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDM9EwUL1Z30vRu
# RqMEfU8P/UVpMdufTqei+hmRhwqkZaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIG1Wfiu/qw1EtV6d
# nFLVVrwIcmNeeyLRg2sCiVaFn7VoMA0GCSqGSIb3DQEBAQUABIICAFP/kh0wqX5A
# LU9XBOB3+ric+JNcjyJ5xcZc6/VKXyucdfkjXTUwDAKG2QLwYix2hcBoT+sae4FR
# 5E8ox0hvk7LR0/sBc6RlqK8hdz6UL+Y7o3KPb93bcOHIPFcexiGBSIdIRO2HEKhN
# p4tdAhx25gbEOv8KQ841xL9kCqPqtLlM4TvMobTlKQUqNzJnYLRm721YX3y3XUjD
# ktP6uJ27u852cw1Y70WwU0bF1Jlzkpn9jb/X0GUAVjM5vLHlgTAprFvSVPxsQ6p3
# OQ6pNNJFrGEn3MtTC//ECdW0F2E5OJaNPBknTo6gY0ChxCkWjlwnoZKiBQ/xHc0I
# glBZ9yWQV8vupaOjO90ZW/Dxz0fzMSLJ3WmEA2oZblgN/li5OwCFMP1c4uYLqAVD
# ExuQ2eaNktvSiF8cM1lg2FJwJGIIF/DmJ948WRP3R8Yfa0fzjPgaU9B0nGh4A0mH
# TIPsoMbOcaDX9SMkZkGZlSCF/a/s85hY2+dyAIPXajv8nBb33XfF1CHeC46s03fZ
# RQ13iOFu1xx1U+XNSmhTC0x1ytErhlvF8SIKjNSbryIiK9FmN5bAZS1OygDhEmWS
# MhMHrDWPmKI2hLNCsMAzfxaV4HyYpHZH2ROkMHy3HPf9PVm0YzG5HtO1/O/zNq6S
# KspSqjslRwV6djGm0JPImk3Pj2iqzkoMoYIXdjCCF3IGCisGAQQBgjcDAwExghdi
...
# IFeIKZ75RXm49xGgxtUlHvFolrze3sfK3GLDHMto+7kLAhAe20L9vPSNVpSDCCsZ
# cLa1GA8yMDI1MDYxNzA4MTQ1NlqgghM6MIIG7TCCBNWgAwIBAgIQCoDvGEuN8QWC
...
# SIb3DQEJBTEPFw0yNTA2MTcwODE0NTZaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYE
# FN1iMKyGCi0wa9o4sWh5UjAH+0F+MC8GCSqGSIb3DQEJBDEiBCAT6ntU1aF9maWG
# T+ECXl8S1TosTgqR1q7y7CiIwZavcDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBK
# oD+iLNdchMVck4+CjmdrnK7Ksz/jbSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASC
# AgCNcyvi67xgTKYKhctp9w63AJKVo7hz6L9T/otYxdChVyL9u8kvx6zcWiLu/GF9
# NwL8WWyRhuXxjRCt/sOQnAylb0w2eVyPmmV9jRokwEFeS3ddy816lau6UnRAEd0n
# suhBFpg8lXUAKWGMDJ/zHq9sEMisVu7I65wJMRIeflCIT4a2ETQmOMYnnx0E6A6d
# WGEXpi+IafOFkyYJ12YXTnMb8B1LGso8u071C8r8zM/4a0O2k++q4sxf2A/MrujL
# VpubrGefHJatLFr22fPucOviDzN6tbG3Y8UB9l+NnzMi49lKM9qVrRARIczg7xRG
# xvKPJLaBKDtQdq3ZAkb2ncww69TV+zwcU8PYCLmCLNozgWWl0dK+qVi+rljo8IdM
# MuIZ5X2EiJ5RfES6APtRQRNsUstCBAgWNLEt8vyVDPS3fXjHKJ/sD+db7bYJFHSo
# R2vAiBeM6l/fbx8dflLicGTclNjijXVnzsoGBvRlZzmZ47TorxTUpUeNsxYsRgDC
# 9xjgOafpUWhz54oxCKkw58Fwkra1e9bSEXHgn+uQW3YAWXBpVfuR1Ibt7c4CGHMu
# 0NUSrsYsvAbN5dogUw/howlyiiItvJ96Wu/HmGri2gzKIQ8Lvz9Me8PZObSmUuLB
# Ri8DrWKbhyOQcGrJvrO8C0SR3ODD6p3n2neCx7B1aS2e8A==

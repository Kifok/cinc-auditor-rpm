# Register Get-VcfOpsOperation Name and Path argument completer
$getOperationNameScriptBlock = {
   param($Command, $Parameter, $WordToComplete, $CommandAst, $FakeBoundParams)

   [VMware.Sdk.Vcf.Ops.OperationRegistry]::GetRegistry().GetOperationNameCandidates($WordToComplete) | Foreach-Object {  [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_) }
}
Register-ArgumentCompleter -CommandName Get-VcfOpsOperation -ParameterName Name -ScriptBlock $getOperationNameScriptBlock

$getOperationPathScriptBlock = {
   param($Command, $Parameter, $WordToComplete, $CommandAst, $FakeBoundParams)

   [VMware.Sdk.Vcf.Ops.OperationRegistry]::GetRegistry().GetOperationPathCandidates($WordToComplete) | Foreach-Object {  [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_) }
}
Register-ArgumentCompleter -CommandName Get-VcfOpsOperation -ParameterName Path -ScriptBlock $getOperationPathScriptBlock
...
Register-ArgumentCompleter -CommandName Set-VcfOpsOperationParameter -ParameterName Name -ScriptBlock $setOperationNameScriptBlock
# SIG # Begin signature block
# MIIpvwYJKoZIhvcNAQcCoIIpsDCCKawCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDttQu9FNQni3HN
# yhF7Wch+iGpvztvnaLjYngdyBi8iMKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGOhr/11sloTbwKe
# ZWPiXpe9OqA+KCgj/GlAy/ttMsfWMA0GCSqGSIb3DQEBAQUABIICAFJ3Fn4kTC2l
# +iKzyhhBHO1xU3uVDnVHOMiF9HrzCWMb7xEqS0FK17uOzqwiP+cid6KSLRJtOVxO
# 9VjAZ8kVjc2c88o8k12KqmxBcVt2DSqgHXlzc83QErtyAbSLjhbtz3abU5FF0zxz
# bhSREVYe7DYh8OkriNz8FK/INHUitFMqYl0RpQc34rKSIFahQZ2ep1p0Dc5xlaJQ
# Hnn3Xg7MVKb7qGhyyhS+UO4SZui4PoOPSF/eWW2kES9HjX+WMYWqHn4+nm14wUBS
# Px5eF6uiOERa9TWuNqVOw7lxgGDUl96U9BeiKVGqZwT9w9tUhUII8Yli8TAdfLmV
# 4NKE8OyEk4c2wKC9l0odSI5+rbXJYFcTX3nZ+TaREIoPswaO5zxsv/fcr9y8VUFA
# d8W7rh6M8qxsTZ1dQSjO0qvnQ1m0ZLl2/Nw4ZJ/SMA7nCtiHvjcmkqatx2ytjNfG
# fQN6nv81BRZaAtFWudhUNvEH5heU4M0h7820KhcY/wemommuZaYKrrb+TT9Z1MZZ
# mWOa6BykgslE+yLBNT+6eVyiiyUQTx0frhKU9oB51iups76AJLZV63Fom7Z0M5a4
# IkjkorXxFveR+ldoITEPftqV6Gr226+tnZREXZjkFQZV4PhFDZ643Ou0m6j8H/O6
# C2p0L0T9Y75uNRWahtLQgodbnNcBPjvWoYIXdzCCF3MGCisGAQQBgjcDAwExghdj
...
# IKiqPjAcmQnr/DUE4W+KKViGGvVSIq9OxxbfQwyJTzWrAhEA0G+UvdjMkct2D8eI
# /2UBbBgPMjAyNTA2MTcwODE0MTdaoIITOjCCBu0wggTVoAMCAQICEAqA7xhLjfEF
...
# hkiG9w0BCQUxDxcNMjUwNjE3MDgxNDE3WjArBgsqhkiG9w0BCRACDDEcMBowGDAW
# BBTdYjCshgotMGvaOLFoeVIwB/tBfjAvBgkqhkiG9w0BCQQxIgQgSJoPb2oAoYIm
# EgFbCu9p2+hQV0KqhPu9mIBW+qFAX8wwNwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQg
# SqA/oizXXITFXJOPgo5na5yuyrM/420mmqM08UYRCjMwDQYJKoZIhvcNAQEBBQAE
# ggIAHkys6aAxaBUZKPbp0VKKkZ9neB+Zbej08eoKp0Ko3fMwdZpAqNr7rhRH8cb9
# T5f7mUYdhiFWBxBzTmCZroN3AP5o7iifhh4Dla9iKF0g/rKpg/sk3XjPiL75Drow
# sbY9CtMTVBdHkn9PzFdACpB6QKTsPQvpPfwrVp+xRuyL7rjokLlxcSiFbiMnJm7L
# O817zYu3VNqiOpeq+YhtQEHMVnOvgXxaUibszfW1J6mwKvXMP0IXORDjlkjTML5C
# uC8Be/nqJeTEVj/js1BSZb5GX/fJ8S/ju3WJSLWL4mWMXCHSAAzkTirURdVWyf6p
# BBArsKNiCjLxcGTzr+h1TVxVItKZXxAnoZJqxpUZso5IKdnNJ6qH1ByV3nTixM9t
# NNGU6PlIlIjV1Y5RqCgOqhctRZqnr1bMMJ+abd4dHAt3IANV36MbKbaRdenSiEwG
# YsbvD2MtCpjJH3zYX8jzu/YQ9UA2SrnSYmhNwkvI6c0YcrfKaT76Ex+5m52o4uFp
# owFcfkfumfQwHwbloBM5bpLO87/+vYpjWVYi2uF4WySxZDUQk9zFYq+tcar97stw
# bHS+P5sFm6OFmRzLf3jepbULtjZYc8AKkcLvFuOg1vfkI6UhkYgkdqICTb1BWEoS
# vsomXTvPtpzRFKoYNwGSyApcoVgeN9KhmWTp9otNO7KRpvY=

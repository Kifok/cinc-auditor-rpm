...
CmdletsToExport = @('Connect-VrServer','Disconnect-VrServer','Get-VrOperation','Initialize-VrConfigureReplicationSpec','Initialize-VrConfigureReplicationVmDisk','Initialize-VrDatastoreBrowserRequest','Initialize-VrDatastoreBrowserResultDrResponseEntity','Initialize-VrDatastoreDrResponseEntity','Initialize-VrDatastorePathData','Initialize-VrDiskBacking','Initialize-VrIssueInfoDrResponseEntity','Initialize-VrPairingSpec','Initialize-VrPairingSpecPairPscInfo','Initialize-VrReconfigureReplicationSpec','Initialize-VrReplicatedVmDiskDrResponseEntity','Initialize-VrRunRecoverySpec','Initialize-VrRunTestRecoverySpec','Initialize-VrSessionIdData','Initialize-VrSessionInfo','Initialize-VrStoragePolicyComplianceCheckDataDrResponseEntity','Initialize-VrStoragePolicyDrResponseEntity','Initialize-VrStringDrData','Initialize-VrVirtualMachineDrResponseEntity','Initialize-VrVmDisk','Initialize-VrVmDiskDrResponseEntity','Initialize-VrVmDiskFindSeedSpec','Initialize-VrVmDiskIdentifier','Initialize-VrVmDiskSeedInformationDrResponseEntity','Invoke-VrBrowseDatastore','Invoke-VrCheckStoragePolicyCompliance','Invoke-VrConfigureReplication','Invoke-VrDeleteVrPairing','Invoke-VrDemoteTestImage','Invoke-VrDestroyReplication','Invoke-VrGetActiveReplicationImage','Invoke-VrGetAllPointInTimeInstances','Invoke-VrGetAllReplications','Invoke-VrGetAllVrDetailsInPairing','Invoke-VrGetAllVrServers','Invoke-VrGetAllVrServersInPairing','Invoke-VrGetLocalVmDisks','Invoke-VrGetLocalVms','Invoke-VrGetPointInTimeInstance','Invoke-VrGetRecentTasksInfo','Invoke-VrGetReplicatedVmDisks','Invoke-VrGetReplicationInfo','Invoke-VrGetReplicationsCount','Invoke-VrGetReplicationsIssues','Invoke-VrGetSeedsForDisks','Invoke-VrGetTaskInfo','Invoke-VrGetVcenterComputeInventory','Invoke-VrGetVcenterComputeItem','Invoke-VrGetVcenterVmFolder','Invoke-VrGetVcenterVmFolderInventory','Invoke-VrGetVcStoragePolicies','Invoke-VrGetVmCapability','Invoke-VrGetVrCapableTargetDatastores','Invoke-VrGetVrInfo','Invoke-VrGetVrInfoInPairing','Invoke-VrGetVrPairing','Invoke-VrGetVrPairingIssues','Invoke-VrGetVrPairings','Invoke-VrGetVrServer','Invoke-VrGetVrServerInPairing','Invoke-VrOperation','Invoke-VrPairVr','Invoke-VrPauseReplication','Invoke-VrPromoteTestImage','Invoke-VrReconfigureReplication','Invoke-VrReconnectVrPairing','Invoke-VrReconnectVrServer','Invoke-VrReconnectVrServerInPairing','Invoke-VrRegisterVrServer','Invoke-VrRegisterVrServerInPairing','Invoke-VrResumeReplication','Invoke-VrRunCleanup','Invoke-VrRunDisasterRecovery','Invoke-VrRunTest','Invoke-VrSyncReplication','Invoke-VrUnconfigureReplication','Invoke-VrUnregisterVrServer','Invoke-VrUnregisterVrServerInPairing','Set-VrOperationParameter')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCRoNkA7eKe2e2i
# wm8hxMfwpzLejQxoqIcILmDQWL1/SaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFDv3sp4zaE7Pfo+
# FvQYIS35iB0Yuoy4+G3N5m+08IjsMA0GCSqGSIb3DQEBAQUABIICAI4QAoy242Pf
# ux2fkCmfZGqkQTeJCBWQO2pDHFtDzIzwMQG7S1N74C571Uis8YeLzgfiQmWZPtMb
# kTAtjhK3j+O9J605j+GOTaBYHsrt7rmQu74NCJFYH22fsl8JA7G1kGmb4I8UHFIL
# v1cDHCJ2udgR5o+sW5Kg8wpt95zp9jWKwe+uOXrmd9BBHbJO7AviWnB3throKxZY
# 2HYgmXFXwBJLko5fXzboB2WXPLo2IkSzMMH+oLU8Bhg16NIzrmBaRfbSQvhjXzbJ
# uK9MOlY3vH3sMbg02YXfHmHz9XtW93ToUBrF5GObivcMGqzbTj4FI9TdSGMLLlQ4
# jIde3lgYZt2uxD2etmzuUjT/QGYmI7b4DjHp6zqMNVrYqH8U5l1IzQN/S8XdhVvF
# vnmdgU9qfvi9KwyaLl+UlSKKLp0hWjEhyVFm2gPw/Q4oN+0UJu/duYRqKMKGLT39
# HL3zKZDV8Qs/mqtqRtuS7toCrEcFf5QyJBdc2rIrLbJAPixpuAaGPFU91RHpNsgZ
# 03RCuWiDtDCDlXY29R9+ERU/k5gkS8Dk+2L0+tNVMPZObYeMPBqhfOXocrKV3dlM
# bpv37MXpar0QoZioapEFlANbXJbSts2xfyZHP6yfFHbRy2guPFPPDml8IaETpcj1
# HQtvRqtnAVII/e42phCzQU7ihGUDsHMeoYIXdjCCF3IGCisGAQQBgjcDAwExghdi
...
# IFcJo/TTJR0Kx+VD2dypK0s+bwJ6ZBcMo29e4ye6NiLwAhAeWmKZ6DU0kD8I6uA8
# SlRXGA8yMDI1MDYxNzA4MTMxMFqgghM6MIIG7TCCBNWgAwIBAgIQCoDvGEuN8QWC
...
# SIb3DQEJBTEPFw0yNTA2MTcwODEzMTBaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYE
# FN1iMKyGCi0wa9o4sWh5UjAH+0F+MC8GCSqGSIb3DQEJBDEiBCDWmnPTrleZdF66
# c6W/OjOQcBTZ3xd+67UUeIHk4Mu02jA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBK
# oD+iLNdchMVck4+CjmdrnK7Ksz/jbSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASC
# AgB477Kv89lM0ECc2JhUj8l2UfdUy6Ury5tsBvOvtQFAyh+bghBTifcNZOhXGums
# dFr/EgyyzJ6jXN3onF6O2HjlFZ3uP5GsPqMPtyT+zv6hALjNfhQuyTApG97oIaj3
# D6gP3isMYvniziDSIz2FBtnomeO7ph3DrrQ/AjZFR9KF+lUXTL0X1mRNF5LpIJ3o
# /FIeGQ1x4dIZPy41jcqFcAqV0+oVy4rVAwCX4ROwh53jxLwTcow721/eh6B9/ETl
# D64wI/mAAnN1B7sDOMOTh+wChEj9j/RKXR46O7SoHxREn/gHcyFiRQhqUbjsZgCa
# pfMNB3x1KibEbqg6ZVsDnK9Vf6ShHaPUawPP2roB4JNIHKFa4ZKTHQ7WeLSAigh7
# r408o1eTAzbpxXh0G0QvsfgOKgXTn0xkWQkQhpn788gi10zVUelv3ZR+AV3s3RZd
# p4grQqCicg3FzBcnS6ajxh/cHNiLWoFvd6RNDyhx8tSttoDpNWWhoC3wX1cMZAJ+
# 3Lk5Lw3ALLFhmEFAweM6Eik0d3CKLnuQgodb2Gj8d9yInePZzNkfwjR5XH98XHyF
# iFDxm3vE8ranVKjGQyBUT31wllg8vOoW0Im7xwZMaKU1UZEWNbgXDRmyiIw6EnKc
# RXkcD5vYUAlPkw6ZPlvjWUqmzy/BdSRMIp41hEUEiEnfxA==

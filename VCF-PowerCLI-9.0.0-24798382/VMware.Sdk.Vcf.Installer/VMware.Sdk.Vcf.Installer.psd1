#
# Module manifest for module 'VMware.Sdk.Vcf.Installer'
#
# Generated by: "VMware"
#
#
...
GUID = '7696886b-7ba8-40b4-a0dd-fb515d809569'
...
Description = 'This PowerShell module contains cmdlets for managing VMware.Sdk.Vcf.Installer API.'
...
FormatsToProcess = @('VMware.Sdk.Vcf.Installer.Format.ps1xml')

# Functions to export from this module
FunctionsToExport = '*'

# Cmdlets to export from this module
CmdletsToExport = @('Connect-VcfInstallerServer','Disconnect-VcfInstallerServer','Get-VcfInstallerOperation','Initialize-VcfInstallerBundleDownloadSpec','Initialize-VcfInstallerBundleUpdateSpec','Initialize-VcfInstallerBundleUploadSpec','Initialize-VcfInstallerDepotAccount','Initialize-VcfInstallerDepotConfiguration','Initialize-VcfInstallerDepotSettings','Initialize-VcfInstallerDnsSpec','Initialize-VcfInstallerDvsSpec','Initialize-VcfInstallerFcSpec','Initialize-VcfInstallerIpAddressPoolRangeSpec','Initialize-VcfInstallerIpAddressPoolSpec','Initialize-VcfInstallerIpAddressPoolSubnetSpec','Initialize-VcfInstallerIpRange','Initialize-VcfInstallerLagSpec','Initialize-VcfInstallerNasVolumeSpec','Initialize-VcfInstallerNfsDatastoreSpec','Initialize-VcfInstallerNsxtManagerSpec','Initialize-VcfInstallerNsxtSwitchConfig','Initialize-VcfInstallerPartnerExtensionSpec','Initialize-VcfInstallerProxyConfiguration','Initialize-VcfInstallerResourcePoolSpec','Initialize-VcfInstallerRootCaCerts','Initialize-VcfInstallerSddcClusterSpec','Initialize-VcfInstallerSddcCredentials','Initialize-VcfInstallerSddcDatastoreSpec','Initialize-VcfInstallerSddcHostSpec','Initialize-VcfInstallerSddcInstallerRequest','Initialize-VcfInstallerSddcManagerSpec','Initialize-VcfInstallerSddcNetworkConfigProfileSpec','Initialize-VcfInstallerSddcNetworkSpec','Initialize-VcfInstallerSddcNsxtSpec','Initialize-VcfInstallerSddcSpec','Initialize-VcfInstallerSddcVcenterSpec','Initialize-VcfInstallerSecuritySpec','Initialize-VcfInstallerSystemUpdateSpec','Initialize-VcfInstallerTeamingSpec','Initialize-VcfInstallerTokenCreationSpec','Initialize-VcfInstallerTransportZone','Initialize-VcfInstallerTrustedCertificateSpec','Initialize-VcfInstallerVcenterDiscoverySpec','Initialize-VcfInstallerVcfAutomationSpec','Initialize-VcfInstallerVcfOperationsCollectorSpec','Initialize-VcfInstallerVcfOperationsDiscoverySpec','Initialize-VcfInstallerVcfOperationsFleetManagementSpec','Initialize-VcfInstallerVcfOperationsNode','Initialize-VcfInstallerVcfOperationsSpec','Initialize-VcfInstallerVmfsDatastoreSpec','Initialize-VcfInstallerVmnicToUplink','Initialize-VcfInstallerVsanEsaConfig','Initialize-VcfInstallerVsanSpec','Invoke-VcfInstallerAddTrustedCertificate','Invoke-VcfInstallerCancelTask','Invoke-VcfInstallerCreateToken','Invoke-VcfInstallerDeleteBundle','Invoke-VcfInstallerDeleteDepotSettings','Invoke-VcfInstallerDeleteTrustedCertificate','Invoke-VcfInstallerDeploySddc','Invoke-VcfInstallerDiscoverVcenter','Invoke-VcfInstallerDiscoverVcfOps','Invoke-VcfInstallerGetApplianceInfo','Invoke-VcfInstallerGetBundle','Invoke-VcfInstallerGetBundleDownloadStatus','Invoke-VcfInstallerGetBundles','Invoke-VcfInstallerGetBundlesForSkipUpgrade','Invoke-VcfInstallerGetCeipStatus','Invoke-VcfInstallerGetCustomPatches','Invoke-VcfInstallerGetCustomPatchesBySku','Invoke-VcfInstallerGetDepotSettings','Invoke-VcfInstallerGetDepotSyncInfo','Invoke-VcfInstallerGetFutureReleases','Invoke-VcfInstallerGetInstallerType','Invoke-VcfInstallerGetLatestSddcSpecValidation','Invoke-VcfInstallerGetLatestSddcTask','Invoke-VcfInstallerGetNetworkConfigProfiles','Invoke-VcfInstallerGetProxyConfiguration','Invoke-VcfInstallerGetReleaseComponentsBySku','Invoke-VcfInstallerGetReleases','Invoke-VcfInstallerGetSddcSpecByID','Invoke-VcfInstallerGetSddcSpecValidation','Invoke-VcfInstallerGetSddcSpecValidations','Invoke-VcfInstallerGetSddcTaskByID','Invoke-VcfInstallerGetSddcTasks','Invoke-VcfInstallerGetSystemConfiguration','Invoke-VcfInstallerGetSystemRelease','Invoke-VcfInstallerGetSystemVcfManagementComponents','Invoke-VcfInstallerGetTask','Invoke-VcfInstallerGetTasks','Invoke-VcfInstallerGetTrustedCertificates','Invoke-VcfInstallerGetVcfService','Invoke-VcfInstallerGetVcfServices','Invoke-VcfInstallerInvalidateRefreshToken','Invoke-VcfInstallerOperation','Invoke-VcfInstallerRefreshAccessToken','Invoke-VcfInstallerRetrySddc','Invoke-VcfInstallerRetryTask','Invoke-VcfInstallerSetCeipStatus','Invoke-VcfInstallerStartBundleDownloadByID','Invoke-VcfInstallerSyncDepotMetadata','Invoke-VcfInstallerUpdateDepotSettings','Invoke-VcfInstallerUpdateProxyConfiguration','Invoke-VcfInstallerUpdateSystemConfiguration','Invoke-VcfInstallerUploadBundle','Invoke-VcfInstallerValidateSddcSpec','Set-VcfInstallerOperationParameter')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAUFchvHemmtGmL
# gQ1eanoA2QAoKwociQIWxcj1KyONTaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIA0cqpQ3yKleVXYI
# 7EQxEXZYi05zVspP4dqPaO8Ptyr1MA0GCSqGSIb3DQEBAQUABIICAAS/+435PSwq
# db0HBTccNxGrirC9KUAEYC3u8i9Yyo3mtaWuDB0+9vBmKzi0K4jFHocM+RILPfMD
# TE8eEa31/Ns6tCC4TjjZuoHOTkCl41PYRJSPkUcBbKB9JMnviRMI2SX0jeIHuKBP
# bEYrG6P5xLOxqcRpTnzWRAw3slTjufKQyPdC28bdoVBSMCw0Mh3zTmcSyW3KuR2r
# klfiiicJBCjbv5pFwNJIqwEnua2EeOZr9IUbVoqo1oY1dk0ZRTlBP+8DEhD0nugd
# fY58kzMfMDN9jme3l8+qfbmM3QTouu//HP1UFuQ7ZQavH7LpigKBw6KizRarOLc5
# 5Ipn+5NTVhBfp0LlNjM8vF/uZziM3E6B/zBJT3B/gA0By4aDzIEtUO2t0pcjQLTI
# 4Mzpi3QUvVlMiEYdq7s07tEtMfsoZzyKXmtWCcx7wtClknL1ZBUR0XpjxPOE4OWg
# TB+qHhEbdo5AYF0M4TrZkE1E5xzCRNrLB/3SFUqjD4JprXj9ugn4tBDeQqw+GIGD
# HgsdOXb1oRTmRlgXD19V77EwriZNxdBaqqd3VtzqJefkLDR6Bvjti6hW0muO/hJC
# JfMTxV41bkBoY3XiJ1+lj5YJ5QTLUzYiYKHNg0hjkGSstqAxrL7ErxYb9PPXnSf3
# v5mBDblUfUvm0Fu98aOAZ/L/QGid2iGuoYIXdzCCF3MGCisGAQQBgjcDAwExghdj
...
# IKO/oKscH9Nvn2fR+AgLAEU3WjdaqT4mFoW85ql91Rg1AhEAsNscCeMGzVn+ISWK
# 3uXQeBgPMjAyNTA2MTcwODE0NTBaoIITOjCCBu0wggTVoAMCAQICEAqA7xhLjfEF
...
# hkiG9w0BCQUxDxcNMjUwNjE3MDgxNDUwWjArBgsqhkiG9w0BCRACDDEcMBowGDAW
# BBTdYjCshgotMGvaOLFoeVIwB/tBfjAvBgkqhkiG9w0BCQQxIgQgCE7umnil+oAz
# MlfNaXfZa+jn5rgYRWNjIusgar7NNfkwNwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQg
# SqA/oizXXITFXJOPgo5na5yuyrM/420mmqM08UYRCjMwDQYJKoZIhvcNAQEBBQAE
# ggIAZafxCGS9uWC2X/hpl6VUPH/oRo8FSisLQK3T6s4cqqGm6k7V2S2jwSLHFOsD
# LBUZTgdckojk2jlpEIGTeQZcNnPElBhasQvaYAILhp/vrviSR3fL9ah5KN1Yy25Q
# t2cqOOWcRg40eRxZUwM5woC1pZS22smCc7QCGpldyTVCRDSSdPiW1ae1hEPQ5Aci
# WdS8rX/+5aMuQocuDXPBqywFRaIgWOV7GE35PFVQdHdW7gSvkrDbPaVbF7y/wFhM
# mlWsCcFgTw8B5NiaNw6/Y3SliUsmNDaZBcHvuJldzVzJP7yIbPTJa09Cv+3pYjTs
# dzNHGcuxeeUBqJLF19ZcOdVlGn5lrwCEgQPc9lXDr+umVZcHlEw2JMPzxeH/nklf
# E70zFxNlSY7ef1sEiQydXfBDUdpPcIK9gKivtUPfqvPFFWqTD4ektETJFdm4uiRa
# AL4rO1CbOV83dGYP/tQUfVxUS6WQRLSYug+D0VzuL6lpmCHiwnQYeD94csOue07C
# +E3aCoh4rK+IpJLBmr/8bG8IPiUMYjsWxU7nmLRSYLUeZBZig0n2BLCrYhZ2or1n
# 9RUEgJk55P3b2B1NPWBAsk7xVGxfNMTRrqwXaWTLKa1bsuMYGUYYHi8sZc24A4n3
# 7pk5MYL9sILfevYxi6S3qnsrIUeGimxi/v8vBIl42qF6rF8=

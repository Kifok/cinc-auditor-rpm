# Register Get-VcfInstallerOperation Name and Path argument completer
$getOperationNameScriptBlock = {
   param($Command, $Parameter, $WordToComplete, $CommandAst, $FakeBoundParams)

   [VMware.Sdk.Vcf.Installer.OperationRegistry]::GetRegistry().GetOperationNameCandidates($WordToComplete) | Foreach-Object {  [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_) }
}
Register-ArgumentCompleter -CommandName Get-VcfInstallerOperation -ParameterName Name -ScriptBlock $getOperationNameScriptBlock

$getOperationPathScriptBlock = {
   param($Command, $Parameter, $WordToComplete, $CommandAst, $FakeBoundParams)

   [VMware.Sdk.Vcf.Installer.OperationRegistry]::GetRegistry().GetOperationPathCandidates($WordToComplete) | Foreach-Object {  [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_) }
}
Register-ArgumentCompleter -CommandName Get-VcfInstallerOperation -ParameterName Path -ScriptBlock $getOperationPathScriptBlock
...
Register-ArgumentCompleter -CommandName Set-VcfInstallerOperationParameter -ParameterName Name -ScriptBlock $setOperationNameScriptBlock
# SIG # Begin signature block
# MIIpvgYJKoZIhvcNAQcCoIIprzCCKasCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAwvWD2iaB0DBkA
# kLnmxcSbZ64sh4OFgl66Ck3z3ALHdKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKRKta/BDDhzZbOV
# stY9wnbHOpoU0rxjNryDnCU3fZ2/MA0GCSqGSIb3DQEBAQUABIICACgRX1CRMyM/
# 2McGPUZsWEJEqDEcrvAOwos9DeGo5QGeikz1EQc+4aI10zUsjCTBiFKv7GEAggat
# Y8ZL/0mGACSFcX+seCciK+Fd6XHJMEyDmmxHNMIO1YL0gdypVNQjBOEHIfYTGf2C
# Pwy1oxe8lZ4t/Xi7ci22aTuyjA6Ax1KncTwbY/hHtd5rlizaqB/Ix27vO4exbC8A
# CL2D5EnnYMvm3xUnNpqzPfVK3kq9JpI4ThZImPywvGZpZph6a4KtfJcnBReEHo1u
# h6VlfaR4XSiPy1JnXsOVaWK/USJVUKbobxc/7KPZ7Ns4SvOSGVDAFrE/QgtcVwT7
# rpLlcBLI6EopYokYkIozhKKuXtUnFb88TUcBu5ZiNtURlsJd6p6pOqj+84dUIoSY
# 5Y1C/ASrhhE5QW5OuDjocgKJMDkaa8aBEYcKuJVIx/aIG0vslfcwtsIWC+0Tw7KM
# rP/z/9kWeH6z1k8OU916QRrgrr2S8/X8pxmrPjnr1e0mF72FRaCqL68oGZkoGvlf
# c6LxcpfGhKxGQ+lAwIs71AJ2eW/c0BF9eOVJbAiknVrV1hvhm149g9najEqTx5WD
# 9GZWZF7YeT4g0UUml8Jx1PiLOLunu41bZzI68uCekdMMtOoMB+XnjjqkMx1HxZyj
# h2+/h4B8KVxUR00UI/UuydzQX7HWEoDvoYIXdjCCF3IGCisGAQQBgjcDAwExghdi
...
# IDaSO575RPVMujfCTjbEPlHAeMJVdzyMhz1ZN8LWQ3rOAhBrWtHRwtRBfotfxqBU
# HPG6GA8yMDI1MDYxNzA4MTMzOFqgghM6MIIG7TCCBNWgAwIBAgIQCoDvGEuN8QWC
...
# SIb3DQEJBTEPFw0yNTA2MTcwODEzMzhaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYE
# FN1iMKyGCi0wa9o4sWh5UjAH+0F+MC8GCSqGSIb3DQEJBDEiBCD9BpM95Tz3vDMF
# HzJVobl3u4ZbGbVvsyXLXHSYx6zpIjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBK
# oD+iLNdchMVck4+CjmdrnK7Ksz/jbSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASC
# AgAatLZLjfeuBnNqbmFoCcdOsbmbJL61/elbUuVgLQRQPpUs3TCV+M+ef1Hrh+ge
# sQW4Ci8gRMwY+u38FZxd0mrQufZyt1xyJsRnNJC9Q7Cd0ZSjzMMy2wqCSE+e5fu4
# w7Qb2jh93sQ8sVaag+uM1eleRcQJfgt8H+52PIGB+Xan6iZ78Ks9f4Wzb0Wi5tLF
# hAnCF8A+kaXevNtuPmoJS7V01wR6Qv9KcbbzFQNKzBlOj2HZZ6G9AURiQWhC8qP0
# KaMInABDqefYRM23oIuF/lWcXvGIyz/t6PCay9f6ud/ZMmnyKa4fc8ASN6FUZDP3
# ZGZvsO08lGQYm96o5v9NkDomp9ACWzk8Ovao3tIrr0/L1uDwE7ty+rsMJnScBWLP
# ItF3Laqs/2D1eTi6+oRrsBLkstVwI1gZRwtKweITgJ3T5dLfs5J+kOa58Q+NEINB
# gv4ybZ5VkXqKmgY0nxhRK1WrV+D1Sq5WiK2YRzRrSx55sQ2uKPA4mSQqN+4wXYM+
# OkwdEaHm6Y3AoHks4qQy1b+zIzlYiXr4ddpE65jyqLwrrX0Uk/7sevyNcJHD7/8r
# nTLxW8+eYRtIvD8z1DI0oAoJbyAjYuirIw2wUPDT2Oyxu8sMJov8MPXEDYosJK9B
# JLm9efi3DH6lgU10LXTj+Am87S5FtgWUuQCJcWMQzhlABg==

...
$getOperationNameScriptBlock = {
   ...
   [VMware.Sdk.Nsx.Policy.GlobalInfra.OperationRegistry]::GetRegistry().GetOperationNameCandidates($WordToComplete) | Foreach-Object {  [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_) }
}
...
$getOperationPathScriptBlock = {
   ...
   [VMware.Sdk.Nsx.Policy.GlobalInfra.OperationRegistry]::GetRegistry().GetOperationPathCandidates($WordToComplete) | Foreach-Object {  [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_) }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDC5oABHg/c7ipO
# U9GDf+zDk5swm5fGnU9Msxl42hsf6aCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDYbVNSVKFDAlPsI
# C/x++wLLcy5Ml92VKpr3ArYudK3XMA0GCSqGSIb3DQEBAQUABIICAAEIIVJL3LZp
# aBfSl5n1/pvtelX6UeQ7+FqlAMQ1cM8WmnO/CTndjfT4R1EHKyBioykzO9LPAhjc
# ur/t2kGF9REleDy2rFknYWRyXYHZZ6qvDyTdKJi9mTyRUDWLEsaqFyI+4o09M2NX
# DORGA/j2x59v8GFrmdZV9tfmqtZhen5Gl4c8wrhGr2YnGhC8i8Cph5H86vkvg+bp
# HumXbp1991XlTXZ1g0ssECZ9X/kBO0QkyC8VdH/HJR79cetSxczoWMT5fEA3tAjR
# CF2tKHagw0C34s+bCEyLFJ4sBVHTYGKyfuIhu+2UPgYNA0nT0zaCBT9FozoB+odK
# KKdQb7uN9iVtRa22b+Q6oOOYBqgWAzDRECo/2XMB9TxjzmsP4g9x+Tx8zP3+CCji
# qThFTmwyCfPqXHRvgrLnlBCVEOVB4a8c8wpClJRcx6Ua1MQL7SwYTo+Eb2oG5WEu
# K5HLNjAJx3oaLt+Kj6viUtZDUWHxjkua+om5wmB7s9ov5Ep/hqKHY2cZTsh9e4T3
# BnWJeD/GU90xKtbPhA5wnfEzzj8aCaiGwGoebFxJBscAI6zfh7nvNTKllQX1kVfp
# dTLXueNyHuwkflymubgDFbJGAqT5ozxGIQTj/QiS/C48U/u//ypiEtbJAGsgYizi
# hR3+OUdE5dVbmYzqBWsJ8WJk6mJyFwECoYIXdzCCF3MGCisGAQQBgjcDAwExghdj
...
# IGuh/ydIPEld9pLCWzyDcog+Hfebtc6B21PAJeBcaTf4AhEAqLszxxr21HdoAmiC
# d8/0zBgPMjAyNTA2MTcwODE2MThaoIITOjCCBu0wggTVoAMCAQICEAqA7xhLjfEF
...
# hkiG9w0BCQUxDxcNMjUwNjE3MDgxNjE4WjArBgsqhkiG9w0BCRACDDEcMBowGDAW
# BBTdYjCshgotMGvaOLFoeVIwB/tBfjAvBgkqhkiG9w0BCQQxIgQgdo1b2XL5a9pv
# 2vILz9L2vHuWylF5RJ89FQ4rJs+LVGEwNwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQg
# SqA/oizXXITFXJOPgo5na5yuyrM/420mmqM08UYRCjMwDQYJKoZIhvcNAQEBBQAE
# ggIAwxenl37QitUJ9cd+4y/bbZyOP1DEQRIZHuGYn3faICUU90uj39qHh6gZq7kM
# p5kX8Y89EN20G9OKf8dyI1hrdN/jV9QWGnAfsEILA+AKb43BZ1XxxzOxBDvoDIU9
# TQ+fYCrexJZii3t+B3Niy9UlnBDWWReTSfa0n4CGOKLGxlz7CFtlwTUov4HHUAP6
# TP85birXkkwk18lJU+nJBLLbMfi+ND+XT5v179pbll89p219RTtG1PUy9VIWrmsD
# Dv5zLbheRDTyc9z/PYoOxOAGU+Me3bvrKbbc7hJVbAeYYiGGdrhRtoQkzcpaUlTD
# m7yxFH5R4Vqyu/OFvNd3rvobe+Y1qYXhdt4amvjPK4JehMr2GWAVS2eVT0Yjkwvf
# 0bQdDEJbxXvO7w3SkYwE/6GHI1RR1avHLsArIF9tHObkRtQcM+8Igsge+N2xytT+
# 036U7w8XErKYFLXjQr0/zGq0fXR39MeJnBFWHNCYNnxtmz8zCAtxzd1xXx8fB8DE
# FQ1M+7azZxTpDJJvXOupltf8hxxWJ2f8jvWjOYZROGkTuEar5k14NvTMhLho4X6x
# hCPA4SvG1dsSUct+Cpx484LVUjmHPFTz/E5naCw4KqUoPcUeAuISgNMLKARaVfZH
# V49vjJPKoqBQTQOFv56xwEJFrJon7IZcVWSIqz2I7fJ943E=

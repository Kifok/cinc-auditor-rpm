# Register Get-vSphereOperation Name and Path argument completer
$getOperationNameScriptBlock = {
   param($Command, $Parameter, $WordToComplete, $CommandAst, $FakeBoundParams)

   [VMware.Sdk.vSphere.OperationRegistry]::GetRegistry().GetOperationNameCandidates($WordToComplete) | Foreach-Object {  [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_) }
}
Register-ArgumentCompleter -CommandName Get-vSphereOperation -ParameterName Name -ScriptBlock $getOperationNameScriptBlock

$getOperationPathScriptBlock = {
   param($Command, $Parameter, $WordToComplete, $CommandAst, $FakeBoundParams)

   [VMware.Sdk.vSphere.OperationRegistry]::GetRegistry().GetOperationPathCandidates($WordToComplete) | Foreach-Object {  [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_) }
}
Register-ArgumentCompleter -CommandName Get-vSphereOperation -ParameterName Path -ScriptBlock $getOperationPathScriptBlock
...
Register-ArgumentCompleter -CommandName Set-vSphereOperationParameter -ParameterName Name -ScriptBlock $setOperationNameScriptBlock
# SIG # Begin signature block
# MIIpvgYJKoZIhvcNAQcCoIIprzCCKasCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCjyzO+PU+Owkzb
# +pu9xbsoCUjTkhtltWScPM7DSRoSEKCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHcuDlK4+4NcB81u
# z/W/3JBPbCsDJ/yn41h+CoCXPFjoMA0GCSqGSIb3DQEBAQUABIICAAQjPvoGNl+x
# IQHULV0IPnh6rw8QGiklkZ2aZOay002qKvITAe4zLh5URsId9FxBLQIeB3vkUlnL
# ZtS61ZcHn6jJ/WZ01XrGSuy0hdUN65Y/T6se68e2BWa9K2uhFmhGAM8Z4is0NJep
# p6hcOgyhigoRiF7sNJd3nJRjwxEAXE+fsb5nR/zvJr2gbinbZlsePRfW8pl4FNyX
# lMXElIlZk7b1gmimIaAobu7At7Y1sY/5b/VQ/7qoWsnIuwlVHv/qnh/uTgfnnvVI
# Tv9kDq+2OWdnvqgx2vPi+auVqyYNBGcXqidwz7W80tKi0pBw/442b8AKFa+TuYYE
# RaS4Zp3Vz6uCPsnp6zmoPT+2v1MUD7qvJqyyXyPYRJh2uyeXZxHSPrXMuptUQdNa
# j0T3/1sdrx8uySr8pUBSDgiecc20t3hmyrQTqdd5AyNMw+OF4uxvCkI8RWqvO9ov
# 17llHJmbkHzJ5rk+qVUFnEysWOWsgyVOxYGba5JhNhfM78cZlYPPo/IFLeLXjcou
# oq6AerUOvYH75n7Mw4ssmfwFN8weOL+bVq0+uoYvHzevdz+yoiTGohesMLZ9SRqR
# 5UWJAXCmuQCD3Dmc3o+TY1vR8ONyASgLniMkjoZCgDmFMV/N9h2/G8Ot5ZmVXhBr
# 4oThqBCIMJ3kcCGWzO9pNLjf4vLqlPyboYIXdjCCF3IGCisGAQQBgjcDAwExghdi
...
# IIGLd6NCY6XxZTYfjtZKkavTZLqJIX/8+3tVe/UrUbyVAhAJreqNTmaHaCbOGvrW
# SF1kGA8yMDI1MDYxNzA4MTgzMFqgghM6MIIG7TCCBNWgAwIBAgIQCoDvGEuN8QWC
...
# SIb3DQEJBTEPFw0yNTA2MTcwODE4MzBaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYE
# FN1iMKyGCi0wa9o4sWh5UjAH+0F+MC8GCSqGSIb3DQEJBDEiBCA8xxWtEleRhOGE
# vjMum37/Cj0ZGeJiKtLPcogyv+5PezA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBK
# oD+iLNdchMVck4+CjmdrnK7Ksz/jbSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASC
# AgA1JX0b0g5I0mNyIXX2wz4Afjl5ZjEQW0D2iR2awxV89vnZMoJ8BHAlpWK52Kcs
# lYvvQqPgmRCccwQMgXMiEVYr1Be8O3Irm65cMjk+qACCV0Buq0Z3bA5oexNJJTwE
# AsvLpe99eDguMFeNjBWchGKMjZMMsUPv5iUA/TLDpd0nEK9wlb9HjfBBraAvu/R1
# DHAtpjTWrD4gQN9t48q4aRQ/7Q61DBISCHjzDTLK22Qzc7TrVRcpCpMB+PN2gZSJ
# lMq4bCh2o6ka0NScO1o+1nK0PSp2ShbvN+jIRChAMV+S7TGK0c1DCMiTTbeTQOXs
# E1YrxBK65nAlpKEag8+mgZ2CJk+4AhhuWlnKyP9vkv+dBTKlDjS+aJEuwYfmAeG3
# rpGDGmyoqcv454sAsPLNAz7eFKyObQwW91M3QkKm0VFwsemDAsEZmExT0Ucsa+Ze
# n1qnNjdCgEGXqCIJz7eV4FcRwrzS+nVtQoFVV9yTJnt+aL5vVYbNhi/IA1Pyafpz
# iXbSwl+IxECTaZTh5BbWkqFCe+Pa22y1c+kuI0lafQPhOwtfSIyK4lNsc53wNRKy
# m0laLitnp1Ha1JFKuNgRvB13ePg3p3nkUlroV8GImDX9ls1wtETVqdVY28cU6ksE
# qZzD3i8guEG9lhzaTzgk7SuhYxNVta13KQaMJTAn1P6cjw==

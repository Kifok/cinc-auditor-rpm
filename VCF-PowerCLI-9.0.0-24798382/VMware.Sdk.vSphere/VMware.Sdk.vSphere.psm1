#
# Script module for module 'VMware.Sdk.vSphere'
#
Set-StrictMode -Version Latest

$binaryModuleFileName = 'VMware.Sdk.vSphere.psd1'
...
if ($PSVersionTable.PSVersion -lt [Version]"7.0") {
   ...
   . (Join-Path $binaryModuleRoot 'VMware.Sdk.vSphere.Register.ArgumentCompleters.ps1')
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAQOHgztYVBqjNA
# XBzIxpv1TsPaDzndRcL118J3hnG/46CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIM1j9zCK8r+jSCBK
# OCZk81DW0ZvcSziUOhjCPZnUOlN0MA0GCSqGSIb3DQEBAQUABIICAAwg561ZAFgf
# nBfkydj7p0DiGGjWgW5eBQgi38a9jvFkW89iuHEwgpDcs/e1fq45RMZJooL/vUxt
# wFjJ+EGDkOEUtCltBCK6qYgDBNQoVKasw2hwc0CqY1P5I1jWOvJYNp6axc4sg4QY
# 02jl5r2lSZfnVCUGzr9V3RejIY0o7SWbZkhXz08qimsGoK/clEsE4XHLonJWrFnS
# ZlMkk0t6/l6UmazgDtDvEqSsoWOkHdpAdRW1KciAr/oxVNBib3U6TVmj9uvxcoWS
# keVqOn0+KjcptjAFPp1gjc/4uJoNsso9YIE4QVV1DZDZYhCZcCBfgEDEm3Yahvma
# ugB9wTmg3tDLE1FEEgyg7Z4mi3oHfiH1soyBLY8BUzHtiY5olZBY8TIwu5dimTKB
# +CpzlgY+rSrzoqP7adRt5z9JFjtk+KTBTrzJFVZ3bU3JKqiVKLAWCkHexyW8xrWC
# 4zLdhN80erUu5P/oHu/g6AM7IUDKiXRVXvqp62NR0zXCO6IuGlwA+8THrhHkWyKc
# cM38ti5xj++UoZKjyWQzsEVppvMom5c8DRh5EosByPshfENzlDjOxWWN0mtAvDdE
# fF4asmXDLTd1lfbnjpG6jisQQtdTcgiN5y99XwFg0iXwABJB+Y0Ub4lphH5oSzbq
# mx+Ohq7WH605Hxm21LTDkq5eNYJQB2A8oYIXdzCCF3MGCisGAQQBgjcDAwExghdj
...
# IAOtrFmcR3WT/SbuhkCG3jbU2UHsjl0KxnTnBLVoDvF1AhEAsEmSVDoQMeS1vLnK
# 5pbLCxgPMjAyNTA2MTcwODE4NDFaoIITOjCCBu0wggTVoAMCAQICEAqA7xhLjfEF
...
# BBTdYjCshgotMGvaOLFoeVIwB/tBfjAvBgkqhkiG9w0BCQQxIgQgCJVD7EWyeEb1
# IBomKPD5rZ/RHPiqQERR4v2zTJ4/+WMwNwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQg
# SqA/oizXXITFXJOPgo5na5yuyrM/420mmqM08UYRCjMwDQYJKoZIhvcNAQEBBQAE
# ggIAacVqemnf5x4bd4gVKGQ/JHCeir7AKF1jULzeK49QiRON0YBaLtiKmbovlXLx
# lvRHHZrXpma2sSMoyS1qN1EopduaZzZhf3FlujHYmpFCzy/JKqty6PZA7L3hvURp
# 3Ee1eoyIDjQHgkcVgBjtC2Zo13jr18fCezkEGfwfzY78knf7DbrfqwNAEXFFYP4F
# mLktbfPA9JxeY/+SHliq4Ler0z9fciAoiUQDr1w8kp2GqMrHICksdoHDbC4qakRj
# dqaUWChrYCUjAVberWOqvE3ky3KbrSASFM0jzLLOMvwhExpHTFs6D+syMPEq3/3a
# ttJHFzjF26tCVs1Od3+DaIp+tJdCWIAJ9R1hD8CNTQIELSRiPvK9qETotGVzSfGs
# mXGqV3pXT0y2Yx4056aoIs8CpEbm3Zsrjy0hMS6ZP0qMKD9yxUx4sDfkNjie42FA
# Jot2LL8U74VN7HoF+Y5Izcc+2ZXNOybF1OFuhmWbBnIuLL1G1lLdbvqamO4nTj/c
# IhKkcUTQsFTlBMH2gKHFM4VuwcJaBmlh1ErFNHjsUYu+wSkWPf3gAy7xfrJzy6qc
# ADktHZNr00FB1AjkmJPGUf/5YhkM3ljKnpPC/3PmsddZDU7ZeWBf++ATm+gXe6om
# ALjtg/x95lOxaJv6u5asefMprsmPa9cryl/Oo5tVIsbSA6U=

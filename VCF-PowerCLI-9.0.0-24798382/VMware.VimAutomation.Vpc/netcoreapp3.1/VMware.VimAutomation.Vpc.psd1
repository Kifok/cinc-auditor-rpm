#
# Module manifest for module 'VMware.VimAutomation.Vpc' core version
#
# Generated by: "VMware"
#
...
RootModule = 'VMware.VimAutomation.Vpc.Commands.dll'

# Version number of this module.
ModuleVersion = '13.4.0.24798382'

# ID used to uniquely identify this module
GUID = 'd2cc7da6-43b5-4962-9eda-a8801115d94b'
...
Description = 'This PowerShell module contains PowerCLI NSX VPC cmdlets.'
...
RequiredAssemblies = @(
    'VMware.VimAutomation.Vpc.Commands.dll',
    'VMware.VimAutomation.Vpc.Impl.dll',
    'VMware.VimAutomation.Vpc.Interop.dll',
    'VMware.VimAutomation.Vpc.Types.dll'
)
...
FormatsToProcess = @("VMware.VimAutomation.Vpc.Format.ps1xml")

# Modules to import as nested modules of the module specified in ModuleToProcess
NestedModules= @('VMware.VimAutomation.Vpc.ps1')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCk8qDCzt2lk2Ro
# iEsosj6upJ4eQrxRSO1SI8qcGjs2tqCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAdQ9qE/4lQ40uPW
# vhlu33iEJxEuP33IFMdldh9hWzfSMA0GCSqGSIb3DQEBAQUABIICADCs8Co2nO4Q
# 245VM+4UzM2Ac/vByXu8atMhIod3uMcuvmS+P12txZRmsjMayWtDqEaSsJKfd6S7
# I8w5ztWh/8CBHgRhIhWK6jbOFcfPF1p6ZUIEPh/mTeZo+kTXnjOIMG5RaQIw3ddV
# t809jj8kMnTfjes4sz9kIsF7wKesL688Vmj2IukHwCnh5vu2FK6/3C1BFyDBQpg3
# ivyo9R6kc3VHN5P/4FU/gDEdEHARIusk0n0I7PmUVHcLPcFup5Xh41634D5lnMc0
# M4TysvN8By3UUh70xFWmWYKKljJB0vRxZ8gjcyRw8U5AdMPOqbxmiBmmk7lqCXBo
# uTpZmrzA3O/g16x6E1cuR3pJJNcZ1K5trU6JD7zjaX8UgkiGFVnYNXreQ9mnzYWE
# LfXVxSMWLW5PCiLBcvsxspf7tGxX5Cw/jy7t4a171J90FSMEu7BjUgTtP6AyYujS
# 8cTjmu7SrbFK4lgRfEzhKYCF7jm6v/kfsGjILFTgx3IuSLkkWRW3TGJteJlu0CJ2
# LR7JXo8KwY5gdQMBa/u2Ihiex2xtojMArQzoq2/gTfjN33dPjTDM2wMzWfw8UmdS
# miXPJDHl1kdL/Ndyp7hFGXFbRpW1C+4XZvGqOC7d33O5JCLSYUvUz/5RgfR1XdY4
# i2cRTpN2XXHJM4cH9g4EvxRnjtyoWpv+oYIXdjCCF3IGCisGAQQBgjcDAwExghdi
...
# IFcWSQCGyoc1S7GsCIryCEsMOgivVtkT6v6xYSbDUobeAhAaZWZ6CIejFDoUTga0
# 4jryGA8yMDI1MDYxNzA4MTg0MFqgghM6MIIG7TCCBNWgAwIBAgIQCoDvGEuN8QWC
...
# SIb3DQEJBTEPFw0yNTA2MTcwODE4NDBaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYE
# FN1iMKyGCi0wa9o4sWh5UjAH+0F+MC8GCSqGSIb3DQEJBDEiBCAEGhRNgqLu9YKq
# 11fBXcFrq/spXbdMdzyLe0+oKoRewDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBK
# oD+iLNdchMVck4+CjmdrnK7Ksz/jbSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASC
# AgCR85UoJzLx9ZXiklr0pWs5vXC4wQb4HsHxDwVXoDw3jrLQJCknsObzTxN+PcY9
# /+dq5GjqSrggzwqsqwivLsG4VipjVYA5n8dvgTKPg1/+jkrah65mvho7wXx2ej4g
# 2cbZgWaN93x2603EC+SAAobjcNpvIrs9dCy9z+QOKutzAxyxlYZAo0zRfhFc2U+C
# bWmQg5KAqKE8LrHnIrHlRVou+VKvw6PbtQDPbtIZ95cNsFvEWSkm6H0T0qd8EW5m
# VgfXSHVbvByj0uheKyC27yGNbddgO87J7yuZcFrq5dJEnsN6FBzbpiS+9JYUczzS
# AkdGY+I+8+Lq3VxMhXo0MBmvSWx1GAsiGZHnyuvAjYtAu18D1w/9Ml7ZD8dLuN83
# 3PhMgYMtZ9ueajAt0zApbvFrNJJNfSVnjI/PAFZBZhND/qrJGgSYv7Q425OSSdGn
# EHgZ/gnGl+BHTv53xsqXjloagLV22Aj0JsFQuY9sAL9KXTOIj6Qm7c/kcV0UmNp+
# fckKcl8WrLmI0E+7oPNZAjUV+1qeZrAh9mYHPPi+v7RQm6YnU3g683mFDeBn8+jt
# ozYB4H0akh1dj4LUBZv+JfkZuQZZ1r+2M0uDZKPMdySuMEERIeyG2cvz2+7M5NYR
# lzyYn/X2wZ4Or9fS1Jyd1/93x/UIamzPNsbq4kvhXmUmFQ==

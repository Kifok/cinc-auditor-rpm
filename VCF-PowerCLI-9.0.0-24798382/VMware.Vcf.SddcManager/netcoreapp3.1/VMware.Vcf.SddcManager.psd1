#
# Module manifest for module 'VMware.Vcf.SddcManager' core version
#
# Generated by: "VMware"
#
...
RootModule = 'VMware.Vcf.SddcManager.Commands.dll'

# Version number of this module.
ModuleVersion = '13.4.0.24798382'

# ID used to uniquely identify this module
GUID = 'c19b5b69-9bd5-44f2-ae6b-7d076903c71f'
...
Description = 'PowerCLI module for VCF SDDC Manager.'
...
RequiredAssemblies = @(
    'VMware.Vcf.SddcManager.Api.dll',
    'VMware.Vcf.SddcManager.Commands.dll',
    'VMware.Vcf.SddcManager.Impl.dll',
    'VMware.Vcf.SddcManager.Interop.dll',
    'VMware.Vcf.SddcManager.Types.dll'
)
...
FormatsToProcess = @('VMware.Vcf.SddcManager.Format.ps1xml')

# Modules to import as nested modules of the module specified in ModuleToProcess
NestedModules= @('VMware.Vcf.SddcManager.ps1')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBXARBIlwbpThtS
# yhW65LINJufWUz7d8S6720G6WLgogaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICeMdWSQHjs1Fjjc
# CXaArqC+qZEHh5ssca0cQ2AjmqsfMA0GCSqGSIb3DQEBAQUABIICAAVlH8IGxgkQ
# yt9/kCFvxvLrcAN4pme1/iN8lT/D0sngFZQ1nEfcbJDd8tbAt+iT/MnznMQ8dloO
# aIP4E1xVgY/+CF9P3c6IhOwz5WrArNtYIekUe4XLFZLukTdYGULUMo5wvEjP7Hkn
# LOIQfZMVkuvWw49rqHTzDuz8JxFvg7CyENjteVBYcWLJ3j5/v1Kq1K66c+GKnTSL
# U0Nb4LOTWSmGHt8v3QHDyfRwOCbtZWaCtzrkK5pJ96GHb0+CJWK7ffb41Hci5xXL
# cF7tttFA5hEKuzBrkxcPwYo5Mx0LKKq8qzX41xVuQ3UBGdAOhB7B6akOQ6mW0dE/
# q0IHU+Zkqa2Pa2HDtXO6kD2Ghm5mbrovjdqYS+HQPtIksd54/T3fPkQ/+PSwET8P
# BHCOnUQOKukmPhRwJNmM3822LhRpUhNiEPlIbAHtbjpFVajWTZJfVkiY2BXfGvNu
# 3uJfErsTEtWuhi49RSPkCASjlkHQ8WjnuDC4z14fIx60WuP5wTkue/s9EyOjmEDB
# kV07cWQxPIzeA1GNcQyJ+aiTa1LPwYevgbRnJWsLSpq4DF0hHRWbV/+y/jBugBUa
# 28kdXwSLLyiSyx5GEpbXeWPXEeMf7SALwetIs7PxeFGri8xoirr9AdWfJ6Q12Bp0
# 7IO4gGj5sObMuP/M31Ik8dmRp2HW7BTPoYIXdzCCF3MGCisGAQQBgjcDAwExghdj
...
# IF24VeMnvVCyN2JMRxQm8/3ncoCiPW9e9Cxgqs7b6rZTAhEAj3S+i1qeEGxAKM3k
# mAUfVxgPMjAyNTA2MTcwODE0NDJaoIITOjCCBu0wggTVoAMCAQICEAqA7xhLjfEF
...
# hkiG9w0BCQUxDxcNMjUwNjE3MDgxNDQyWjArBgsqhkiG9w0BCRACDDEcMBowGDAW
# BBTdYjCshgotMGvaOLFoeVIwB/tBfjAvBgkqhkiG9w0BCQQxIgQgLEjrv7ii7fJl
# 8YRTjZXOACkOS8eMdC2iWgLCWgysS+cwNwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQg
# SqA/oizXXITFXJOPgo5na5yuyrM/420mmqM08UYRCjMwDQYJKoZIhvcNAQEBBQAE
# ggIAfABaFgyYZVk59E70lLzRma4Sx6RAHMA71WXnHaR53SJeQphKtf0nAPh0zO7+
# FSsS29l/i/ZtvsfNXECqsA6y3ivBNESm60NxntlOlJLPfrpUZcoJ3L26MKYzbyE4
# S9ommwYn/fTSOBaSVam27skpSaoSFkjCMrg/xCuTuAKW5f5/KNEDQ+uL/6ea/CLZ
# r9sWCxn5TmBSIF99j7q+kwj1xW91RGaLpVfo1ecU8OGXMrBPuYTXzyxl7kUb/aa/
# fqYEvTykckaT3r3C/6Z4tpUJsSosIzAjDX1n3Kfi14wlkShWAFd5HeH2+zC55BK0
# gBt+7qRHY2NUpImkfKkUXHBVMImE/5d2LEcAjHlM/P/gLOZSl0IMMhDP2OnDetJB
# DEKn1zLNToVWwL/9Kmp9KZXFBzCnbjqItGvsPHB8EVJkFDr2cXl1g42lLE2RGBnl
# 17prlizSpW9cpDG4umnIrhMOr+eA1+drfKYeKCS2YN4wzlvhLVl9SSnY9gzBt1sU
# J1SdlJfpQ9T+E3qzJbHsjmiC5GOnOl6pkVkfmNsxiYoYlVXZMmyK50IR7Myb8vU5
# +1ZbGrEig4zZWhKxt290mx0wcI32z5v8XZzB4AVBwi5GlB8dpC2RKxebA9FutZUN
# vMyiYqxaZWW5Xf5VYsohjNcWqW6Vh1zb4aUp23XN2whkrzY=

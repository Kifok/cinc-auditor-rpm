[VMware.VimAutomation.Sdk.Interop.V1.CoreServiceFactory]::CoreService.OnImportModule(
    "VMware.Vcf.SddcManager.Impl",
    (Split-Path $script:MyInvocation.MyCommand.Path));

[VMware.VimAutomation.Sdk.Interop.V1.CoreServiceFactory]::CoreService.OnImportModule(
    "VMware.Vcf.SddcManager.Commands",
    (Split-Path $script:MyInvocation.MyCommand.Path));
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCeDgd3MMgYCzxj
# +tm1KqULZuulGW2SxryFdHoBIKbJr6CCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIN+n4qEmmli2U/dV
# 3xOSs31hULR/uyb/5HMgaPQT5OBqMA0GCSqGSIb3DQEBAQUABIICAJn4rc86heqy
# V2g3oeAdyC1TJHPx06wW5vgu8w8hQ3HkSl8oF/ysdO32D26AF3N4G1hV5a+ErUJR
# OraXwqzJxFdfNGFbovVq6+MDlksEWLTxtGAXF8cfNN9veXXggukW8GuA5hc4Vn3w
# CFcFVPVL+aAloC/1NntQ4ZMqF7FFZqd+9sApA/ewdwp1aIDZMz43N4lveULD5Jwm
# FfJ2KUFK7hsuzucBnwkvAgIkBPI/4pAlaeR7r8v6rvFmQqCNmG1tW03qj93WQbka
# VXZGHGYobbUOPmA/DVQxjyd8j8f3V7GETQ4Twla99DdxzOqxQmlzUJJkBvQmVW0g
# YIUqTo3gLkVqPSDft/6+GvOlck8ZBrbDRVNNBlgXd9xHrO4Nc2IgLt2o4RjH4TCt
# Bjso8OWRgroLkMqhAMERLuswRqKVVr+5eRHjM3LBsCAS+m2IE+BqVWsN2tKIYGDx
# t0sfUsmkHuE8jM90Id+q9BuR+XRV1sM5VGJdwYXXrdu/x8LpZAgFO7vLal6lm+Fo
# NP8lhMRRL5ahMylpUsyzChz44pj/4NqwoflkIxQcm3tTWJtlZOiIj4lS/iJ/jB/1
# y4dc26eJxo5OQIreYWCCz8PwCC9zuHT7ra3qYsV2eppgdj2gaPEMNrB8lxYCdMD1
# tiW2Giv03BLHTeTWIM1wdQK5+uTEEBPJoYIXdzCCF3MGCisGAQQBgjcDAwExghdj
...
# INZAepGC7Qy80I9djVNnBcB/ARhehPgxYsNdOdlZOUVTAhEAmkbzX3QwXb94tm4Q
# VM4ZcRgPMjAyNTA2MTcwODE0NDNaoIITOjCCBu0wggTVoAMCAQICEAqA7xhLjfEF
...
# hkiG9w0BCQUxDxcNMjUwNjE3MDgxNDQzWjArBgsqhkiG9w0BCRACDDEcMBowGDAW
# BBTdYjCshgotMGvaOLFoeVIwB/tBfjAvBgkqhkiG9w0BCQQxIgQgcaFyn9KwBndH
# tg3t5Y8AvGZei/gFUgCOwq5Rou0/ItUwNwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQg
# SqA/oizXXITFXJOPgo5na5yuyrM/420mmqM08UYRCjMwDQYJKoZIhvcNAQEBBQAE
# ggIAwY43TAMIbA4jJV13UlU+6zpuNGhCRo1y3RfnocjlD9blR8jh1biwTc8Zwt+F
# aWc5OQbqX8+TIpGEnll+XNV6J3NTscPkNYdZKapexWi0lXPy3UCkAE+LvZTX9cPY
# gOHOo13ttgxeX7JY/cdIEu9mQMasbE9saSfdllx5FzJf4CFKyl2JgqmjjdhIzBmk
# c1jv80lb78N3eIjfeIVbuPcN7YbOHPFUvTOY2nrVzTYKQFSW+mqGCWR9HVEHPCt0
# achAusRjokTRdXTKel31HcN8gHzWl6+yXlCUiIunqcXyJqBX5B8/griorPcgToIU
# 1ZvcA4uNxhNZauSmT+euc/XY9WEGBXTlCMrCPI3JWn5S6mC33DYQiTfmTNGNNlqw
# EM9Pdd+I514pUiVyB33MnvbjOAOdQQxtzV9524blWWFFb0EzG3yQMxte2eECnntn
# lV1XJ3Ijxss0f/F/jj8SxVtIDNdkSj64bIGJTVmnpp6AgZwRp1yPvtsWbRkcMIZr
# ucMQm4KmyZ9TS23pWLH1d+W//3ldKnm4FEOg4hwKtsAS1dmJE86E+AkbniW7O6Y8
# pf08+7c6cELqMqUHT3yhXn/pZ9q20BmfS9tfsXyeixzDDMRxDvtv57eRIPcDHp4M
# jweWsYFgniCKM/HZCcBd3QjfdiyhjRhtFimS0vZOAfIwmRM=

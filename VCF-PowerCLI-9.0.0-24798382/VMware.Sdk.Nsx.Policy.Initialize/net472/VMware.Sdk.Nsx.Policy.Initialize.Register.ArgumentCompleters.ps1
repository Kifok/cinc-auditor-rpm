...
$getOperationNameScriptBlock = {
   ...
   [VMware.Sdk.Nsx.Policy.Initialize.OperationRegistry]::GetRegistry().GetOperationNameCandidates($WordToComplete) | Foreach-Object {  [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_) }
}
...
$getOperationPathScriptBlock = {
   ...
   [VMware.Sdk.Nsx.Policy.Initialize.OperationRegistry]::GetRegistry().GetOperationPathCandidates($WordToComplete) | Foreach-Object {  [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_) }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDQJx4/pZlOAyKW
# 6y7T0yiTz9WiUz9H6AR12pbhNce/1qCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGlqnMZebFfPof3W
# d6keRTlC1hz+ismspDwJ2g1JfGPRMA0GCSqGSIb3DQEBAQUABIICAKWiGPuyeo32
# IOMlVTe7ymxbnsoBmFU2+bHSQw/2fab9nMylo+xRt8FV6mccU2dqlwd8b14PVV+c
# Gg9mn+d548iwyZJON3VlAwzufdOVEA7SVzPX0ddoGd3h73cZz/uamh+C191xzPVK
# KSwD7C/rJv7jFcczri9i5yDrapPFyptJvfO68lCFhWfyxUQSt4kWsOr0E6uOcekO
# o65M8c1BJerWgZdQDraHMEFLd02jClx2oaiFauqccBWl7QChwplh2UwE0MjbE7um
# z18cbLA95GG1PVXZ9qOdoeXgSl6adGzZfmeamFN7j2GHvmPDSMWmyIqADSCHcffg
# YfDg1bsIwtJ4Id9kCFVox5uLyK/PciOKfb0ll/wSfcpC+OG3p8aTgQZI/iUcJQNe
# Cm+3iUUEXR3XSQICN9NEhzB//VN22uYQoep2QEUsiSrN+eU2MYZ8RylSNzJx4ZXS
# KjyJTyVxg7GmMbdDSQyt1OHiQPMfYRjDCHa/vLvcPsm30jxP2Pk6oWCPZSG7H2Po
# WQfy4W8z94+fGfPOwvSaIbT31PKgD8hSinxGNGRa+c0UZQsg5RD1id0K5FD+WiZ7
# B5BL83v4QKrKxphTGvaqghUqQoeydZ/ifTZOAdNcwQDc3PfEsMbbBhLWUpc0+7A3
# PsSwF/ExqQ3jTjopoZQZvmld2K611ms5oYIXdjCCF3IGCisGAQQBgjcDAwExghdi
...
# INEdq6B6RhL79kbqv6UuqU8OmdjYLFL9GlP988jkqv8bAhAPw7SvkDme89MK9Wev
# j//dGA8yMDI1MDYxNzA4MTQxN1qgghM6MIIG7TCCBNWgAwIBAgIQCoDvGEuN8QWC
...
# SIb3DQEJBTEPFw0yNTA2MTcwODE0MTdaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYE
# FN1iMKyGCi0wa9o4sWh5UjAH+0F+MC8GCSqGSIb3DQEJBDEiBCBPhFMr+11QKMzj
# 4XFU73pRu9X/NQB0UivyXW0OCHfIkDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBK
# oD+iLNdchMVck4+CjmdrnK7Ksz/jbSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASC
# AgC8nobMMapgeIaIQUHgHno7O/S60bgrImjaqutZjA1hoymnlBjuS45lhU24+uCZ
# +oz0WGdlt3gk0aK0O8rrJqhq+XRb3ehxdnuY0KGbWYrrMWp9poQsHmZbVdaGET0R
# sFFddgDEPCUHsn+CUM7onajytE9DgsmOuAbzuBm6r6eEv9IhHX/gsADYxscrV0k/
# E016HnFIhzi60QTMCtvtqqmA606822yyxoyd5Iox+adlSC+SsFO8E8PIDLUBDnzY
# aHEwEFMVnS8UqthjXWC1umbMIwvExtpoak76M7tUQGsT0yE9Mi7hHLi8h13P8NU5
# VoJzrcTYMTHrh0vz7pJw6hxtDfcOUZjcf96MoPseTC7kmkdDAzfklHyYCEpltL7o
# hnmn3+V5gp8UG5FPRu47Xe4Viv8Lwkl6MtzbBMhG77RBNRoaJtr4njD+gPDvNVJb
# KM6Pg+QqBjWhxcHBzeCfWzp6Yyv12REMhla4Zynil48x8c0U9wLpoxG5eXBrjYoB
# ioVXGXvrP7q9XXqYxuJNL4EnIJT7ZxTLPKcRCi+Q/MMpRdYdg+yGi2LxFJeVduBn
# 1Qm46G9j9CAZxpPo3/XkywsKf+n93U82kL5fKo5eIF8+kN3+KnPFOPf60MFj7Gs3
# IusCXlDDz+C6aJg3vg/cWNVq9/cwCvzSYkwQiM2Np3EWjw==

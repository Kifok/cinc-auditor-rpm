#
# Module manifest for module 'VMware.Sdk.Nsx.Policy.Initialize'. Core version.
#
# Generated by: "VMware"
#
#
...
ModuleToProcess = 'VMware.Sdk.Nsx.Policy.Initialize.Cmdlets.dll'
...
Description = 'This PowerShell module contains cmdlets for managing VMware.Sdk.Nsx.Policy.Initialize API.'
...
RequiredAssemblies = @(
'VMware.Sdk.Nsx.Policy.Types.dll',
'VMware.Sdk.Nsx.Policy.Initialize.Cmdlets.dll'
)
...
# FormatsToProcess = @("VMware.Sdk.Nsx.Policy.Initialize.Format.ps1xml")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAurvoRd0a/1nex
# hJH1+zmOKpQM2r8tA3GpAsQC8kZeLaCCDnQwggawMIIEmKADAgECAhAIrUCyYNKc
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINk9ZQBEkOyhratg
# vq6rMt+C5KOA1NCwq9UP81IhlvhDMA0GCSqGSIb3DQEBAQUABIICAAu6EqWLfPt0
# ny+M6WzG41MvyxgHgJK/cpd1GquAnUcw9GBegUp89XUz+gLPuvA4a1IlS2MJ4VXw
# nH8SWuaPjMJXTnZkXbcIDGewIs054asfAlrUjHuLCblSxgT71aM9obaBJ/4n5bVf
# RniLUelT91OMpHj9vPJGtos05z4vIjW3PWd+mde6WKGcraGSYb8PhRV7QOStNut6
# 0vtauFr3ER9Sl0Oiqpdh1Zw+SNuK+oXYUmibw/kvlY9mm+BKGmJApAmq9ZoXVvxc
# ssEUOIQS0yPYtg/twdaXpdX5GVCF/uRuoJ82S9Tg0YPqg2i/0JDQAdLt0ZeVPLlz
# R4newHtrRWvzY/v1EwmMbHxg0bwK1C5/c0HK0ijvZ6EPyM6PZBqVPeAXKvcB4OXU
# allG1JZzoFrH0whNJ77e/3o0ZitY0qWN5XDihemaOw/JqpmvBEdiY/8g5Tc+gswm
# bGlnXcCzvrEQBxliOldexttHqlPLhagOgvO2KmIhtDpam8p6Xh2kSO2pTVVmHydZ
# rQf6cG5R4lXNdyDgwT4fko1u6ZWUvzdszG4TD0VpIsibfr3xAODZm2PQbwcgVHCB
# IFV4L9gVo3chR8/FuQDZX1qnHYKcMqLAQNb26EwZzIW8zxg4irQAyckhdE1GML3y
# TQy1jr91NFaUUgQvsqSbWzAb33X+LOwPoYIXdjCCF3IGCisGAQQBgjcDAwExghdi
...
# ILN1ENrGqQVPUIePA6xRVehF5BRHTeeGhLXuKrhMZqMkAhAY8tKhKGcsjOB+XTpu
# tm5VGA8yMDI1MDYxNzA4MTQxNVqgghM6MIIG7TCCBNWgAwIBAgIQCoDvGEuN8QWC
...
# SIb3DQEJBTEPFw0yNTA2MTcwODE0MTVaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYE
# FN1iMKyGCi0wa9o4sWh5UjAH+0F+MC8GCSqGSIb3DQEJBDEiBCC4DNR8syIVKSLn
# vTSr8B1knUHBkIrFB05fTyWidXpT8TA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBK
# oD+iLNdchMVck4+CjmdrnK7Ksz/jbSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASC
# AgBSXCLl+ImVkx9L0YgnpEf0MMu/jvmfk6fP1KcEzp8Se5wC6ukURQ1shgaG61ZB
# h666J9OiijSSeYQZc5bDsJB1yzx/rVFX424BaEGTf9j5vAAWAudUMLMB68AW1DdS
# ZTyzg181llW7Edvu1PMMFVWVtO8A3TeEWf+rT5KCEeJkWjp29SKVS9KeekcfVWcc
# UXZcNAXiPGhyUlKjq9F6vZKrU1OUkQjv8TzqTJ3Hu889c2UNLEkk335tnSmRyjFQ
# igGI8JhiTHFJtRpcDHQKh4KIrID1f26iIHffk5JPpo8ZBjqy2DCimKvuVjxhTjWK
# ioL4stIxG8tvm1w2pAe3BR/k+63bPYOz3WkayUviPa7wIzQSB1+ZZAqDgTiofbw1
# uiVILnhCWTnnOWVCW0Axyol28evX5RNgnA0F3NsHJRyJHulVtEFm6ICejMVGfoeW
# 7XgcUzu7r/xVSX+9LaGRUOXr6iNlYHDFIiVAITZSNf+aQqEdsqJAeCEthIUZgE5r
# vBu+ZfHJygtS/AwVwYJe8LgaxViQQtXv6N9Dw39KN/Ov0/uJ1dOsXouVLCP59cGq
# LKq6AsBy/PiLCd73Yl9U/G6PTyTVaPEyFnsPL9C8Vs7+DX2KC3t+UtGEJg68JVzy
# T0cBoNRA9mva4QTwNxOU/p2MNiZ24AZyThDbf4GUMMZv6Q==
